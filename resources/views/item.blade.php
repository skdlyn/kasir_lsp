    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('item.edit', $item->id) }}"
                                            class="btn  btn btn-sm btn-warning">Edit</a>
                                        <a href="{{ route('item.hapus', $item->id) }}"
                                            class="btn  btn btn-sm btn-danger">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </table>
                ...
                <a href="{{ route('category.index')}}" class="btn btn-sm btn-warning" style="margin-top: 20px">Category</a>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if (session('status'))
                            <div class="alert alert-success" role="alert">
                                <button class="btn btn-sm btn-close" data-bs-dismiss="close"></button>
                                {{ session('status') }}
                            </div>
                        @endif
                        ...
                        <form action="{{ route('item.store') }}" method="POST">
                            ...
                            <div class="group">
                                ...
                                <input type="number" class="form-control" id="stock" name="stock" min="1"><br>
                            </div>
